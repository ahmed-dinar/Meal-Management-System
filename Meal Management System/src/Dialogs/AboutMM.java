...
public class AboutMM extends JFrame implements MouseListener {
	...
	private void Init() {
		...
		lincence.setText(" Meal Management System is a non-commercial, open source utility application"
			 + " to make maintain meal record,account record easier.I start this project"
			 + " in my own interest. Copyright (C) 2015, Maid Ahmed Dinar.\n\n"
